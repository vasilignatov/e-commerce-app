                        ...
                        <div className="row">
                            <div className="col-md-12">
                                ...
                                <p className="m-b-40">
                                    ...
                                    <br /> trends to see any changes in performance over time.</p>
                                <p><a className="btn hvr-hover" href="#">Shop New</a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <li className="text-center">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12">
                                <h1 className="m-b-20">
                                    <strong>Welcome To <br /> Thewayshop</strong>
                                </h1>
                                <p className="m-b-40">
                                    See how your users experience your website in realtime or view{" "}
                                ...
                                <p>
                                    <a className="btn hvr-hover" href="#">Shop New</a>
                                </p>
                            </div>
                        </div>
                    </div>
